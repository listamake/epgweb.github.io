            ...
            <div class="program-info-container">
              ...
              <div class="program-info">
                ...
                <span class="rating-info">
                  ${programRating ? `<span class="rating-square rating-${programRating.toLowerCase()}" style="background-color: ${ratingInfo.color};">${ratingInfo.text}</span>` : '<div class="rating-info">Classificação não disponível</div>'}
